...
typedef struct VersionTripleList
{
    union {
        VersionTriple *value;
        uint64_t padding;
    };
    struct VersionTripleList *next;
} VersionTripleList;
...
typedef struct DirtyBitmapStatusList
{
    union {
        DirtyBitmapStatus value;
        uint64_t padding;
    };
    struct DirtyBitmapStatusList *next;
} DirtyBitmapStatusList;
...
typedef struct BlockDirtyBitmapList
{
    union {
        BlockDirtyBitmap *value;
        uint64_t padding;
    };
    struct BlockDirtyBitmapList *next;
} BlockDirtyBitmapList;


typedef struct BlockDirtyBitmapAdd BlockDirtyBitmapAdd;

typedef struct BlockDirtyBitmapAddList
{
    union {
        BlockDirtyBitmapAdd *value;
        uint64_t padding;
    };
    struct BlockDirtyBitmapAddList *next;
} BlockDirtyBitmapAddList;
...
typedef struct MigrationParameterList
{
    union {
        MigrationParameter value;
        uint64_t padding;
    };
    struct MigrationParameterList *next;
} MigrationParameterList;


typedef struct MigrationParameters MigrationParameters;

typedef struct MigrationParametersList
{
    union {
        MigrationParameters *value;
        uint64_t padding;
    };
    struct MigrationParametersList *next;
} MigrationParametersList;
...
typedef struct PciBusInfoList
{
    union {
        PciBusInfo *value;
        uint64_t padding;
    };
    struct PciBusInfoList *next;
} PciBusInfoList;
...
typedef struct PciDeviceClassList
{
    union {
        PciDeviceClass *value;
        uint64_t padding;
    };
    struct PciDeviceClassList *next;
} PciDeviceClassList;


typedef struct PciDeviceId PciDeviceId;

typedef struct PciDeviceIdList
{
    union {
        PciDeviceId *value;
        uint64_t padding;
    };
    struct PciDeviceIdList *next;
} PciDeviceIdList;
...
typedef struct RockerSwitchList
{
    union {
        RockerSwitch *value;
        uint64_t padding;
    };
    struct RockerSwitchList *next;
} RockerSwitchList;
...
typedef struct RockerPortDuplexList
{
    union {
        RockerPortDuplex value;
        uint64_t padding;
    };
    struct RockerPortDuplexList *next;
} RockerPortDuplexList;
...
typedef struct RockerPortAutonegList
{
    union {
        RockerPortAutoneg value;
        uint64_t padding;
    };
    struct RockerPortAutonegList *next;
} RockerPortAutonegList;


typedef struct RockerPort RockerPort;

typedef struct RockerPortList
{
    union {
        RockerPort *value;
        uint64_t padding;
    };
    struct RockerPortList *next;
} RockerPortList;


typedef struct RockerOfDpaFlowKey RockerOfDpaFlowKey;

typedef struct RockerOfDpaFlowKeyList
{
    union {
        RockerOfDpaFlowKey *value;
        uint64_t padding;
    };
    struct RockerOfDpaFlowKeyList *next;
} RockerOfDpaFlowKeyList;


typedef struct RockerOfDpaFlowMask RockerOfDpaFlowMask;

typedef struct RockerOfDpaFlowMaskList
{
    union {
        RockerOfDpaFlowMask *value;
        uint64_t padding;
    };
    struct RockerOfDpaFlowMaskList *next;
} RockerOfDpaFlowMaskList;


typedef struct RockerOfDpaFlowAction RockerOfDpaFlowAction;

typedef struct RockerOfDpaFlowActionList
{
    union {
        RockerOfDpaFlowAction *value;
        uint64_t padding;
    };
    struct RockerOfDpaFlowActionList *next;
} RockerOfDpaFlowActionList;


typedef struct RockerOfDpaFlow RockerOfDpaFlow;

typedef struct RockerOfDpaFlowList
{
    union {
        RockerOfDpaFlow *value;
        uint64_t padding;
    };
    struct RockerOfDpaFlowList *next;
} RockerOfDpaFlowList;


typedef struct RockerOfDpaGroup RockerOfDpaGroup;

typedef struct RockerOfDpaGroupList
{
    union {
        RockerOfDpaGroup *value;
        uint64_t padding;
    };
    struct RockerOfDpaGroupList *next;
