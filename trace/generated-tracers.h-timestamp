...
static inline void trace_mirror_break_iov_max(void * s, int nb_chunks, int added_chunks)
{
}
...
static inline void trace_vfio_platform_populate_regions(int region_index, unsigned long flag, unsigned long size, int fd, unsigned long offset)
{
}
...
static inline void trace_vfio_platform_mmap_set_enabled(bool enabled)
{
}
...
static inline void trace_vfio_platform_start_irqfd_injection(int index, int fd, int resamplefd)
{
}
